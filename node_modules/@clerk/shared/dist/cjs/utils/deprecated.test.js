...
describe("deprecatedObjectProperty(obj, propName, warning)", () => {
  ...
  test("deprecate object property shows warning", () => {
    ...
    (0, import_deprecated.deprecatedObjectProperty)(example, "objectProperty", "Use `objectPropertyElse` instead.");
    expect(consoleWarnSpy).not.toBeCalled();
  ...
  describe("for test environment", () => {
    ...
    test("deprecate object property does not show warning", () => {
      ...
      (0, import_deprecated.deprecatedObjectProperty)(example, "objectPropertyInTest", "Use `objectPropertyInTestElse` instead.");
      expect(consoleWarnSpy).not.toBeCalled();
  ...
  describe("for production environment", () => {
    ...
    test("deprecate object property does not show warning", () => {
      ...
      (0, import_deprecated.deprecatedObjectProperty)(example, "objectPropertyInProd", "Use `objectPropertyInProdElse` instead.");
      expect(consoleWarnSpy).not.toBeCalled();
